...
# install tidyverse package using the command install.packages("tidyverse") 
...
## `select()` selects certain columns
...
## Piping, `%>%` (Ctrl Shift M) using the outcome of funciton 1 as an input in function 2
