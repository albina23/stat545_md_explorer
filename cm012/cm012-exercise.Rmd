...
> From last week
> vector: a sequence of "entries" of the same data type 
> character vectors: an "entry" can contain any amount of characters 
> lists: a sequence of "entries" of any type 
...
- has __levels__ 
> levels are possible categories it can take 
...
> fct_reorder2 used here, looks at country, then year, then lifeExp
...
> need quotations around both entries, if strings 
