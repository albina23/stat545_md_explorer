...
6. Try again, this time by changing the _scale_ (log10 scale - this way is better).
...
5. We can add multiple geom _layers_ to our plot. Put a jitterplot overtop of the violin plot, starting with our base `b`. Try vice-versa. Benefit to know how many points is in each data group. 
